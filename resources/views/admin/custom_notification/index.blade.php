...
<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">Notifications 
                    <a href="<?= url('admin/custom_notification/create'); ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    } elseif ($row->userIds=="all_users_from_csv_file") {
                                        echo "All Users from Csv";
                                ...
                                <td>
                                    <a href="<?= url('admin/custom_notification/edit/' . base64url_encode($row->id)); ?>"><button class="btn btn-sm btn-danger">Resend</button></a>&ensp;
                                    <a href="<?= url('admin/custom_notification/detail/' . base64url_encode($row->id)); ?>"><i class="icon-eye"></i></a>&ensp;
                                    <a title="Delete" href="<?= url('admin/custom_notification/destroy/' . base64url_encode($row->id)); ?>" onclick="return confirm('Are you sure you want to delete this notification ?')"><i class="icon-trash-bin"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
