    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body">                                       
                    <form method="post" id="addForm" enctype="multipart/form-data" action="{{route('admin.custom_notification.store')}}">
                        @csrf
<!--                        <div class="row">                            
                            <div class="col-lg-6">
                        ...
                        <div class="row">                            
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" name="users_mobile" id="users_mobile" value="1"/>
                                    <label>Send users from csv file</label>
                                    <input name="user_mobile_csv" type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
