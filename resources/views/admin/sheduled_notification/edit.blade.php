...
<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">Edit Push Notification Shedule</h4>
            </div>
            <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body">                                       
                    <form method="post" id="addForm" enctype="multipart/form-data" action="{{route('admin.sheduled_notification.update',[base64url_encode($notification->id)])}}">
                        @csrf
                        <!--                        <div class="row">                            
                                                    <div class="col-lg-6">
