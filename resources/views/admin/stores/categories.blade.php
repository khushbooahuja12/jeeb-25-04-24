                                ...
                                <tbody>
                                    @if ($categories)
                                        ...
                                        <tr class="vendor<?= $row->id ?>">
                                            ...
                                            <td>{{ $store->getAllProducts()->where('fk_category_id','=',$row->id)->where('store'.get_store_no($store->name),'>',0)->count() }}</td>
                                            <td>{{ $store->getAllProducts()->where('fk_category_id','=',$row->id)->count() }}</td>
                                        </tr>
                                        <tr>
                                            <td>
                                            </td>
                                                        ...
                                                        <tbody>
                                                            @foreach ($row->getSubCategory as $key2 => $row2)
                                                                <tr class="vendor<?= $row2->id ?>">
                                                                    ...
                                                                    <td>{{ $store->getAllProducts()->where('fk_sub_category_id','=',$row2->id)->where('store'.get_store_no($store->name),'>',0)->count() }}</td>
                                                                    <td>{{ $store->getAllProducts()->where('fk_sub_category_id','=',$row2->id)->count() }}</td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
