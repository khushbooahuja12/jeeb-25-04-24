    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body">                                       
                    <form method="post" id="regForm" enctype="multipart/form-data" action="{{route('admin.stores.store')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="store_name" value="{{old('name')}}" data-title="Store Name" class="form-control regInputs" placeholder="Name" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="latitude" id="latitude" data-title="Latitude" value="{{old('latitude')}}" class="form-control numberOnly regInputs" placeholder="Latitude">
                                    <p class="errorPrint" id="pinError"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="longitude" id="longitude" data-title="Longitude" value="{{old('longitude')}}" class="form-control numberOnly regInputs" placeholder="Longitude">
                                    <p class="errorPrint" id="pinError"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation" data-title="Confirm Password" class="form-control regInputs" placeholder="Confirm Password">
                                    <p class="errorPrint" id="pinError"></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Api</label>
                                    <textarea name="api_url" id="api_url" data-title="Password" class="form-control regInputs" placeholder="URL"></textarea>
                                </div>
                            </div>
                             
                            {{-- <div class="col-md-12">
                                <div class="form-group">
                                    <label>Select Storekeepers</label>
                                    ...
                                    <label id="storekeeper_ids[]-error" class="error" for="storekeeper_ids[]"></label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label id="driver_ids[]-error" class="error" for="driver_ids[]"></label>
                                </div>
                            </div> --}}
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $('#company_id').on('change',function(){
        ...
        $.ajax({
                url: '<?= url('admin/stores/create_company_store_name'); ?>',
                type: 'post',
                dataType: 'json',
                data: {company_id: company_id},
                cache: false,
            }).done(function (response) {
                $('#store_name').attr('value', response);
            });
    })
</script>
@endsection