            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= url('admin/product_tags') ?>">Product Tags</a>
                        </li>
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <form method="post" id="addForm" enctype="multipart/form-data"
                            action="{{ route('admin.product_tags.update', [base64url_encode($tag->id)]) }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="file" accept="image/*" class="dropify" data-show-remove="false"
                                            id="image" name="image"
                                            data-default-file="{{ !empty($tag->tag_image) ? $tag->tag_image : '' }}" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <input type="file" accept="image/*" class="dropify" data-show-remove="false"
                                            ...
                                            data-default-file="{{ !empty($tag->banner_image) ? $tag->banner_image : '' }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="fk_tag_bundle_id" data-title="Tags Bundle" class="form-control col-md-3 select2" style="width: 100%">
                                            ...
                                            @foreach ($tag_bundles as $tag_bundle)
                                                <option value="{{ $tag_bundle->id }}" {{ $tag_bundle->id==$tag->fk_tag_bundle_id ? 'selected' : '' }}>{{ $tag_bundle->name_en }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
