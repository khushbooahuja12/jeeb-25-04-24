    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body">                                       
                    <form method="post" id="createMultipleForm" enctype="multipart/form-data" action="{{route('admin.brands.store_multiple_images')}}">
                        @csrf
                        <div class="row">                                                    
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Select Multiple Images</label>
                                    <input type="file" name="brand_images[]" accept="image/*" class="form-control" multiple="multiple">                                    
                                </div>
                            </div>                            
                        </div>
                        <div class="row">
