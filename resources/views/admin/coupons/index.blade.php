                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a title="view details"
                                                    href="<?= url('admin/coupons/show/' . base64url_encode($row->id)) ?>"><i
                                                        class="fa fa-eye"></i></a>&ensp;
                                                @if ($row->expiry_date > date('Y-m-d'))
                                                    <a title="view details"
                                                        href="<?= url('admin/coupons/edit/' . base64url_encode($row->id)) ?>"><i
                                                            class="fa fa-edit"></i></a>&ensp;
                                                @endif
                                                @if ($row->expiry_date < date('Y-m-d'))
                                                    &nbsp;&nbsp;<a
                                                        href="<?= url('admin/coupons/recreate/' . base64url_encode($row->id)) ?>"
