                ...
                <td>
                    <div class="content">
                        <table class="t-width2">
                            <tr>
                                <th>Invoice to:</th>
                                <th style="padding-top: 63px !important;">{{ $order->getOrderAddress->name ? $order->getOrderAddress->name : $order->getOrderAddress->mobile }}<br>
                        ...
                        <div style="margin-top: 50px;" class="row t-width">
                            ...
                            <div style="text-align: right;" class="col-6">
                                <p class="account-y">
                                    ...
                                    <br>
                                    <hr class="hr2" style="width: 350px;">
                                    <br>
                                    <span style="font-size: 23px;font-weight: bold;" class="span1">Total:</span>
                                    <span style="font-size: 23px;font-weight: bold; display: inline-block; min-width: 200px; margin-left: 20px;"
                                        class="span2">{{ number_format($total, 2) }}
                                        QR</span><br>
                                </p>
                            </div>
                        </div>
