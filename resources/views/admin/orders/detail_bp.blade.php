                    ...
                    <div class="card-body" style="overflow-x: scroll;">
                        <table class="table table-bordered dt-responsive nowrap" style="width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    <th>COD / Cash from Card</th>
                                    <td>{{ $order->getSubOrder ? $order->amount_from_card + $order->getOrderPaidByCart($order->id) : $order->amount_from_card }}</td>
                                </tr>
                                <tr>
                                    <th>By Wallet</th>
                                    <td>{{ $order->getSubOrder ? $order->amount_from_wallet + $order->getOrderPaidByWallet($order->id) : $order->amount_from_wallet }}</td>
                                </tr>
                                <tr>
                                ...
                                @if ($order->status >= 2)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('customer-invoice', base64url_encode($order->id)) }}"
                                ...
                                @if ($order->getOrderProducts->where('is_out_of_stock', 0))
                                    @foreach ($order->getOrderProducts->where('is_out_of_stock', 0) as $key => $value)
                                        ...
                                        <tr class="{{$product_class}}">
                                            ...
                                            <td>{{ $value->getStore->name }}-{{ $value->getStore->company_name }}</td>
