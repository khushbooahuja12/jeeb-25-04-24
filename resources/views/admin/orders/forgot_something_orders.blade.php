    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">All Forgot Something Orders</h4>
                </div>
                <div class="col-sm-6">
                                ...
                                @if ($orders)
                                    @foreach ($orders as $key => $row)
                                        <tr>
                                            ...
                                            <td>{{ $row->forgot_products_count }}</td>
                                            <td>{{ ($row->getStore && $row->getStore->name) ? $row->getStore->company_name.' - '.$row->getStore->name : '' }}</td>
                                            <td>
                                                <a href="<?= url('admin/orders/detail/' . base64url_encode($row->id)) ?>"><i
                                                        class="icon-eye"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
