...
<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">User List <a class="btn btn-primary" href="<?= url('admin/users/abondoned_cart') ?>">Abondoned Cart Users</a></h4>
            </div>
            <div class="col-sm-6">
                    ...
                    <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>Sum Of Orders</th>
                                <th>
                                    # Of Times User Activity Traced<br/>
                                    (update_cart / make_order)
                                </th>
                                <th>Address Added</th>
                                <th>Status</th>
                                <th>Action</th>
