    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">
                        Product Stock Update - {{ $store ? $store->name.', '.$store->company_name : '' }}
                    </h4>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" type="text" name="product_store_distributor_price" id="store1_distributor_price numericOnly" value="{{ $product->product_store_distributor_price }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Store 1 Stock</label><br/>
                                                        <input type="number" class="form-control" type="text" name="product_store_product_stock" id="store1 numericOnly" min="0" value="{{ $product->product_store_product_stock }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
    ...
    <script>
        ...
        $('.product_save').on('click',function(e){
            ...
            if (id) {
                ...
                $.ajax({
                    url: "<?= url('admin/stock_update/store/'.$store->id.'/base_products/update_stock_save') ?>",
                    type: 'post',
                    data: formData,
                    processData: false,
                    contentType: false,
