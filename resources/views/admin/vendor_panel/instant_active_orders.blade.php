...
<div class="page-body">
  <div class="container-fluid">
    <div class="page-title">
      <div class="row">
        <div class="col-sm-6">
          <h3>Active Instant Orders</h3>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i data-feather="home"></i></a></li>
            <li class="breadcrumb-item active"> Active Instant Orders</li>
          </ol>
        </div>
      </div>
    </div>
                  ...
                  @if ($orders)
                    @foreach ($orders as $key => $row)
                        <tr>
                            ...
                            <td>
                                <a href="<?= route('vendor-instant-order-detail', ['store' => base64url_encode($store->id), 'id' => base64url_encode($row->id)]) ?>"><i
                                        class="icon-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
