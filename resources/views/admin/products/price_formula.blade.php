...
<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">Price Formula Combinations</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="<?= url('admin/dashboard'); ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?= url('admin/products'); ?>"> Offers & Pricing Formula</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card m-b-30">                               
                <div class="card-body">
                    <div class="mb-4">
                        <a href="<?= url('admin/products/filter_price_formula?store_id=0&subcategory_id=0&brand_id=0'); ?>" class="btn btn-primary ">
                            <i class="fa fa-plus"></i> Add New Price Formula
                        </a> 
                    </div>
                    ...
                    <table class="table table-bordered dt-responsive"
                        ...
                        <tbody>
                            <tr>
                                <tr>
                                    <td></td>
                                    <td style="text-align: center; "><h5>Price Formula</h5></td>  
                                </tr>
                                <td></td>
                                <td>
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @php
                                                $global_store_price_formula = \App\Model\PriceFormula::where('fk_store_id','=', 0)
                                                    ...
                                                    ->get();
                                            @endphp
                                            @foreach($global_store_price_formula as $key => $value)
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td>{{$value->x1}}</td>
                                                <td>{{$value->x2}}</td>                               
                                    ...
                                    <td>
                                        @foreach ($global_store_brand_subcategory_combinations as $key => $value)
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                    $global_store_brand_subcategory_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', $value->fk_subcategory_id)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>                                    
                                                            <a class="btn-sm btn-primary" title="edit" href="<?= url('admin/products/edit-formula/' . base64url_encode($value->id)); ?>">Edit</a>
                                                            <a class="btn-sm btn-danger" title="delete" href="<?= url('admin/products/delete-price-formula/' . base64url_encode($value->id)); ?>" onclick="return confirm('Are you sure you want to delete this formula ?')">Delete</a>
                                                        </td>                                
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                    ...
                                    <td>
                                        @foreach ($global_store_brand_combinations as $key => $value)
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                    $global_store_brand_combination_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', 0)
                                                        ->where('fk_brand_id','=', $value->fk_brand_id)
                                                        ->where('fk_store_id','=', 0)
                                                        ->where('fk_offer_option_id','=', 0)
                                                        ->orderBy('x1', 'asc')
                            ...
                            <tr>
                                ...
                                @foreach ($global_store_subcategory_combinations as $key => $value)
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @php
                                            $global_store_subcategory_combination_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', $value->fk_subcategory_id)
                                                ->where('fk_brand_id','=', 0)
                                                ->where('fk_store_id','=', 0)
                                                ->where('fk_offer_option_id','=',0)
                                                ->orderBy('x1', 'asc')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @php
                                                    $store_price_formulas = \App\Model\PriceFormula::where('fk_store_id',$row->fk_store_id)
                                                        ->where('fk_brand_id','=',0)
                                                        ->where('fk_subcategory_id','=',0)
                                                        ->where('fk_offer_option_id','=',0)
                                                        ->orderBy('x1', 'asc')
                                    ...
                                    <td>
                                        @foreach ($store_brand_subcategory_combinations as $key => $value)
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                    $store_brand_subcategory_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', $value->fk_subcategory_id)
                                                        ->where('fk_brand_id','=', $value->fk_brand_id)
                                                        ->where('fk_store_id','=', $row->fk_store_id)
                                                        ->where('fk_offer_option_id','=', 0)
                                                        ->get();
                                        ...
                                        <td>
                                            @foreach ($store_brands_combinations as $key => $value)
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @php
                                                        $store_brand_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', 0)
                                                            ->where('fk_brand_id','=', $value->fk_brand_id)
                                                            ->where('fk_store_id','=', $row->fk_store_id)
                                                            ->where('fk_offer_option_id','=', 0)
                                                            ->orderBy('x1', 'asc')
                                    ...
                                    <td>
                                        @foreach ($store_subcategories_combinations as $key => $value)
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                    $store_subcategory_price_formula = \App\Model\PriceFormula::where('fk_subcategory_id','=', $value->fk_subcategory_id)
                                                        ->where('fk_brand_id','=', $value->fk_brand_id)
                                                        ->where('fk_offer_option_id','=', 0)
                                                        ->where('fk_store_id','=', $row->fk_store_id)
                                                        ->orderBy('x1', 'asc')
