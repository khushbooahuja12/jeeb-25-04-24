                    ...
                    <div class="card-body" style="overflow-x: scroll;">
                        ...
                        <table class="table table-bordered dt-responsive nowrap">
                            <thead>
                                ...
                                <tr>
                                    <th>Delivery Location Link</th>
                                    <td><a href="http://maps.google.com/maps?&z=10&q=<?=$order->latitude?>+<?=$order->longitude?>" target="_blank">http://maps.google.com/maps?&z=10&q=<?=$order->latitude?>+<?=$order->longitude?></a></td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Added Product</th>
                                    {{-- <th>Store</th> --}}
                                    <th>Driver Collection Status</th>
                                    <th>Storekeeper Collection Status</th>
                                    <th>Storekeeper</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if ($order_products)
                                    @foreach ($order_products as $key => $row)
                                        ...
                                        <tr class="{{$product_class}}">
                                            ...
                                            <td>{{ isset($order_product_status[$row->driver_collection_status]) ? $order_product_status[$row->driver_collection_status] : '' }} - ({{ $row->driver_name}})</td>
