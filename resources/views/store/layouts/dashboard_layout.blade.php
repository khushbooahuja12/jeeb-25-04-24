    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <a href="<?= url('store/' . $store->id . '/dashboard') ?>" class="logo">
            ...
            <nav class="navbar-custom">
                <ul class="navbar-right list-inline float-right mb-0">
                    <span>Hi, <?= $store->name ?></span>
                    <li class="dropdown notification-list list-inline-item">
                        <div class="dropdown notification-list nav-pro-img">
                            <a class="dropdown-toggle nav-link arrow-none nav-user" data-toggle="dropdown"
                                href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{ asset('assets/images/dummy_user.png') }}" alt="user"
                                    class="rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                <a class="dropdown-item text-danger"
                                    onclick="return confirm('Are you sure you want to exit store ?')"
        ...
        @include('store.layouts.sidebar_items')
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                © 2019 - 2020 Jeeb <span class="d-none d-sm-inline-block"> - Crafted with <i
