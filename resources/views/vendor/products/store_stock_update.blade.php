    ...
    <div class="container-fluid">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h4 class="page-title">Stock Update</h4>
                    {{-- <a href="<?= //url('vendor/base_products/stock_update_stores/new_products') ?>" class="btn btn-primary">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= url('vendor/base_products/stock_update_stores') ?>">Stock Update</a></li>
                        ...
                        <table class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @if (!empty($stores))
                                        ...
                                        <tr class="vendor<?= $stores->id ?>">
                                            <td>{{ $stores->id }}</td>
                                            <td>{{ $stores->name }}</td>
                                            <td>{{ $stores->getCompany ? $stores->getCompany->name : '' }}</td>
                                           
                                            <td>{{ $stores->address }}</td>
                                            
                                            <td> 
                                                <a href="<?= url('vendor/products/stock/'.base64url_encode($stores->id)) ?>" class="btn btn-primary btn-sm">Update Stock</a>                                         
                                            </td>
                                        </tr>
                                @endif
                            </tbody>
