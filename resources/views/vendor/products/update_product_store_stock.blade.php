        ...
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    ...
                    {{-- <a href="<?= //url('vendor/all_products/stock_update_stores/new_products') ?>" class="btn btn-primary">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= url('vendor/all_products/stock_update_stores') ?>">Stock Update</a></li>
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <form method="post" id="stepOne" enctype="multipart/form-data"
                            action="{{ route('vendor.all_products.bulk_stock_update') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
            ...
            $.ajax({
                ...
                if (response) {
                    ...
                    if(completed_percent >= 100){
                        ...
                        stopInterval();
                        {{!!(isset($batch_id) && $batch_id!='') ? "window.location.href = \"/vendor/all_products/stock_update/".$id."/".$batch_id."/update\"" : "" }}
                    }
                }
            })
        }
