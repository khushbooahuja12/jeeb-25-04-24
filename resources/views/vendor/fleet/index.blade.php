            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= url('admin/fleet') ?>">Stores</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <a href="http://192.168.0.119/peyk8/public/_administrator_section_/order-list?pass_token={{$vendor->pass_token}}" target="_blank"><button>GO TO MAP</button></a>
