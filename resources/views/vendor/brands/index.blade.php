        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">Brands 
                    <a href="<?= url('vendor/brands/create'); ?>" class="btn btn-primary">
                    ...
                    <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="view details" href="<?= url('vendor/brands/show/' . base64url_encode($row->id)); ?>"><i class="fa fa-eye"></i></a>&ensp;
                                    <a href="<?= url('vendor/brands/edit/' . base64url_encode($row->id)); ?>"><i class="icon-pencil"></i></a>&ensp;
                                    <a title="Delete" href="<?= url('vendor/brands/destroy/' . base64url_encode($row->id)); ?>" onclick="return confirm('Are you sure you want to delete this brand ?')"><i class="icon-trash-bin"></i></a>
                                </td>
                                <td>                                     
                                    <div class="mytoggle">
                                        <label class="switch">
...
<script>
    function checkHome(obj) {
        ...
        if (confirm("Are you sure you want to " + statustext + "?")) {
            $.ajax({
                url: '<?= url('vendor/brands/add_remove_home'); ?>',
                type: 'post',
                dataType: 'json',
