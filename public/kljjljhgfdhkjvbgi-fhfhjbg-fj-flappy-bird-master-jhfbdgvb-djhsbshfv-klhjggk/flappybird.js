...
window.onload = function() {
    ...
    setInterval(placePipes, 1500); //every 1.2 seconds
...
function update() {
    ...
    if(score < 10){
        ...
        context.fillText(30-score+" more to Pepsi-330ml",5,90);
    }
    

    if (gameOver && score >=10 &&score<30) {
        
        context.fillText("You Won Pepsi 250ml", 5, 135);
    }
    else if(gameOver && score>=30){
        context.fillText("You Won Pepsi 330ml", 5, 135);
    }
    else if(gameOver){
