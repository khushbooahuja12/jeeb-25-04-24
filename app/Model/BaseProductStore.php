...
class BaseProductStore extends Model
{
    ...
    protected $table = 'base_products_store';
    
    protected $appends = ['product_price', 'distributor_price'];
    
    public function searchableAs()
    {
        $table_index = (env('APP_ENV')=='production') ? 'base_products_store' : 'base_products_store_dev';
        return $table_index;
    }
    ...
    {
        return $this->attributes['product_store_price'];
    }

    public function getDistributorPriceAttribute()
    {
        return $this->attributes['product_distributor_price'];
    }
